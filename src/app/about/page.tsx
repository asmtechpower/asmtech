    ...
    <main className="min-h-screen bg-[#f5f0e8]">
      ...
      <section className="container mx-auto max-w-6xl px-4 pt-10 md:pt-14">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8 md:mb-10">
          <span className="inline-flex w-fit items-center rounded-full border border-neutral-400 px-5 py-2 text-xs font-semibold uppercase tracking-widest text-neutral-800 shrink-0">
            About Us
          </span>
      ...
      <section className="container mx-auto max-w-6xl px-4 pb-16 md:pb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="flex flex-col gap-4">
            <span className="inline-flex w-fit items-center rounded-full border border-neutral-400 px-5 py-2 text-[11px] font-semibold uppercase tracking-widest text-neutral-600">
              Our Mission
            </span>
